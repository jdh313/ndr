---
id: "0006"
title: "Read-side context-loading via /decisions skill + auto-loaded rule on tracked projects"
status: current
...
> [!warning]- tracked-projects-opt-in
> Tracked projects opt in via a project-level `.claude/CLAUDE.md` marker; specifics deferred to post-scaffold.
>
> - **Current state:** marker mechanism deferred; first tracked project likely the work monorepo
