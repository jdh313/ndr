---
id: '0154'
title: Bulk read verbs skip all malformed files; doctor is the surface that reports
  them
status: current
...
informed_by: []
supersedes:
- '[[Decisions/0138-ndr-bulk-read-verbs-skip-malformed-atoms-targeted-reads-still-throw]]'
superseded_by: []
area: tooling
topic: read-side
impacts: []
