...
aliases:
  - ndr-commit-message-enforcement
project: "[[ndr]]"
derived_from: []
informed_by:
  - "[[Decisions/68gar5-ndr-release-automation-release-please-native-runner-bui\
    ld-matrix]]"
supersedes: []
superseded_by: []
area: tooling
...
impacts: []
revisit_triggers:
  - enforcement proves too strict for merge/revert commits
  - a commit-authoring tool (czg, commitizen) gets added later
reversibility: easy
tags:
  - decision
---
