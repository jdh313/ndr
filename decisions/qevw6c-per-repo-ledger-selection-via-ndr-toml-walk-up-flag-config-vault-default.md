...
derived_from: []
informed_by:
  - "[[Decisions/0130-ndr-decisions-are-project-scoped-with-no-cross-project-ti\
    er]]"
...
impacts: []
revisit_triggers:
  - a repo needs more than one ledger
  - the draft payload's vault_decisions field is removed from the capture schema
...
> [!warning]- capture-payload-precedence
