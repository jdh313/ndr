...
- '[[Decisions/0136-ndr-resolve-brief-format-and-drift-surfacing]]'
supersedes: []
superseded_by:
- '[[Decisions/0154-bulk-read-verbs-skip-all-malformed-files-doctor-is-the-surface-that-reports-them]]'
area: tooling
topic: read-side
impacts: []
revisit_triggers: []
