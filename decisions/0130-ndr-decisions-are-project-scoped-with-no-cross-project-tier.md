...
impacts: []
revisit_triggers:
- A work decision genuinely needs visibility across multiple work repos and a shared
  ledger is the only workable path
- A personal cross-project decision feels durable enough that single-project scoping
  loses the reference
reversibility: easy
tags:
- decision
...
> [!warning]- cross-project-decisions-stay-rare
...
> [!warning]- revisit-trigger-will-fire-clearly
