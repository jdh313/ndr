...
- '[[Decisions/0133-ndr-src-uses-ports-and-adapters-layout]]'
supersedes: []
superseded_by: []
area: tooling
topic: referencing
impacts: []
revisit_triggers:
- id space feels tight (approaching ~10K atoms) -> bump suffix to 7 chars
- human reference via opaque ids becomes painful -> revisit making slugs eager rather
  than lazy (would amend 0050)
