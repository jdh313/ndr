...
name: ndr-bootstrap
description: >-
  One-time install of ndr's vault content. Copies the seed decision atoms (A–H
  meta-chain at 0001-0008 plus reference-addressability resolution at 0049-0051)
  and the initial `labels.yaml` taxonomy file into `~/Loose Ends/`. Idempotent —
  re-runs skip targets that already exist. Invoke explicitly with
